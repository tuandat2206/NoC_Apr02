...
#
# Script generated by Vivado on Thu Apr 04 20:05:34 +0700 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb xil_defaultlib.tb xil_defaultlib.glbl -log elaborate.log
}
