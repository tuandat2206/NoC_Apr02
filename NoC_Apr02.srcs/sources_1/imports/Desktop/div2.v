...
module div2 #(parameter id_width = 'd3, x_size = 1, y_size = 1, data_width = 32, total_width = id_width + data_width + x_size + y_size)
(
    input clk,
    input rstn,
    input r_valid_pe,
...
always @(posedge clk) begin
    if (!rstn) begin
        w_valid_pe <= 1'b0;
            ...
            w_data_pe <= {r_data_pe[total_width-1:total_width-id_width], r_data_pe[total_width-id_width-1:total_width-id_width-data_width] >> 1, xy_size};
            w_valid_pe <= 1'b1;
