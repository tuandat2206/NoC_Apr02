...
module switch #(parameter x_coord ='d0, y_coord='d0,X=2,Y=2,data_width=32, x_size=1, y_size=1,total_width=(x_size+y_size+data_width))
(
input wire clk,
input wire rstn,
...
begin
	if(
	((leftToRight | leftToTop) & (bottomToTop | bottomToRight))// | 
//	(leftToPe & (bottomToTop | bottomToRight) & ~i_ready_pe) | 
//	(bottomToPe & (leftToRight | leftToTop) & ~i_ready_pe)  | 
//	(bottomToPe & leftToPe & ~i_ready_pe)
	)
	begin
		o_ready_pe = 1'b0;
	end
...
begin
	...
	begin
        ...
        10'bxx1_xx1_x1x_1:begin//leftToPe & bottomToPe & peToRight
            o_data_r  <= i_data_l;
            o_valid_r <= 1'b1;
        end
        10'bxx1_x1x_xx1_1:begin//leftToPe & bottomToTop & peToTop
            o_data_r  <= i_data_pe;
            o_valid_r <= 1'b1;
        end
        10'bx1x_xx1_xx1_1:begin//bottomTope & leftToTop & petoTop
            o_data_r  <= i_data_pe;
            o_valid_r <= 1'b1;
        end
...
begin
	...
	begin
        ...
        10'bxx1_1xx_x1x_1:begin//leftToPe & bottomToRight & petoRight
            o_data_t  <= i_data_pe;
            o_valid_t <= 1'b1;
        end
        10'b1xx_xx1_x1x_1:begin//bottomTope & leftToRight & petoRight
            o_data_t  <= i_data_pe;
            o_valid_t <= 1'b1;
        end
